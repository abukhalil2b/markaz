<div x-data="modal_remove_student_from_recorddaily">
        ...
        <div class="flex min-h-screen items-center justify-center px-4" @click.self="open = false">
            <div x-show="open" x-transition x-transition.duration.300 class="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0">
                <div class="flex items-center justify-between bg-[#fbfbfb] px-5 py-3 dark:bg-[#121c2c]">
                    <h5 class="text-lg font-bold"> إزالة الطالب من السجل </h5>
                ...
                <div class="p-5">
                    ...
                    <div> سيتم إزالة الطالب من السجل</div>
                    <div>لن يكون في قائمة الحضور ولا في قائمة الغياب</div>
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        <a class="btn btn-danger ltr:ml-4 rtl:mr-4" href="{{route('remove_student_from_recorddaily',['studentHasRecordDaily'=>$absent->id])}}">
                            تأكيد الحذف
                        </a>
                    </div>

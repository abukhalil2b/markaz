<div :class="{ 'dark text-white-dark': $store.app.semidark }">
    <nav x-data="sidebar" class="sidebar fixed min-h-screen h-full top-0 bottom-0 w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] z-50 transition-all duration-300">
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            @php
            $roleIds = auth()->user()->roles()->pluck('roles.id');

            $rolePermissions = App\Models\Permission::join('role_has_permissions','permissions.id','=','role_has_permissions.permission_id')->whereIn('role_has_permissions.role_id',$roleIds)->pluck('permissions.slug')->toArray();

            $userPermissions = App\Models\Permission::join('user_has_permissions','permissions.id','=','user_has_permissions.permission_id')->where('user_has_permissions.user_id',auth()->id())->pluck('permissions.slug')->toArray();
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'admin-users' }" @click="activeDropdown === 'admin-users' ? activeDropdown = null : activeDropdown = 'admin-users'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">الإدارة</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'admin-users' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'admin-users'" x-collapse class="sub-menu text-gray-500">
                        <li>
                            @if(in_array('view-requestleave',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.requestleave.index')}}" class=" ">طلبات الإجازة
                            </a>
                            @endif
                        </li>
                        <li>
                            @if(in_array('create-user',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.user.create')}}" class=" ">+ تسجيل مستخدم </a>
                            @endif

                        </li>
                        <li>
                            @if(in_array('view-admin-user-index',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.user.admin.index')}}" class="">قائمة الإدارة</a>
                            @endif
                        </li>
                        <li>
                            @if(in_array('view-male-moderator',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.user.male_moderator.index')}}" class="">قائمة المشرفين</a>
                            @endif
                        </li>

                        <li>
                            @if(in_array('view-male-teacher',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.user.male_teacher.index')}}" class="">قائمة المدرسين</a>
                            @endif
                        </li>

                        <li>
                            @if(in_array('view-female-moderator',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.user.female_moderator.index')}}" class="">قائمة المشرفات</a>
                            @endif
                        </li>

                        <li>
                            @if(in_array('view-female-teacher',$permissions) || auth()->id() == 1)
                            <a href="{{route('admin.user.female_teacher.index')}}" class="">قائمة المدرسات</a>
                            @endif
                        </li>

                        <li>
                            @if(in_array('manage-moderator-present',$permissions) || auth()->id() == 1)
                            <a href="{{route('user_record_daily.moderator.index')}}" class="">
                                الحضور والغياب للمشرفين
                            </a>
                            @endif
                        </li>

                        <li>
                            @if(in_array('manage-teacher-present',$permissions) || auth()->id() == 1)
                            <a href="{{route('user_record_daily.teacher.index')}}" class="">
                                الحضور والغياب للمدرسين
                            </a>
                            @endif
                        </li>
                ...
                <!-- student-users -->
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'student-users' }" @click="activeDropdown === 'student-users' ? activeDropdown = null : activeDropdown = 'student-users'">
                        <div class="flex items-center">
                            ...
                            <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">الطلاب</span>
                        </div>
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'student-users' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'student-users'" x-collapse class="sub-menu text-gray-500">
                        @if(in_array('crud-student',$permissions) || auth()->id() == 1)
                        <li>
                        ...
                        <li>
                            <a href="{{route('mark.mark_orderby_tag')}}">
                                النقاط التي حصل عليها الطالب <div><small>حسب المحاور</small></div>
                            </a>
                        </li>

                        <li>
                            <a href="{{route('admin.student_mission_task.count')}}">
                                مجموع المهام المنجزة في مسار حفظ القرآن الكريم
                            </a>
                        </li>

                        <li>
                            <a href="{{route('admin.duaacate_student_task.count')}}">
                                مجموع المهام المنجزة في مسار وقل رب زدني علما
                            </a>
                        </li>

                        @if(in_array('manage-inactive-students',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.student.inactive_student_index')}}">
                                قائمة الطلاب المعطلين
                            </a>
                        </li>
                        @endif

                        @if(in_array('manage-waiting_approval-students',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.student.waiting_approval_student_index')}}">
                                قائمة الطلاب للاعتماد
                            </a>
                        </li>
                        @endif

                        @if(in_array('show-all-students',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('student.show_all_students')}}">
                                عرض كل الطلاب
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('admin.record.daily.late_search')}}">
                                البحث عن الحضور المتأخر
                            </a>
                        </li>

                        <li>
                            <a href="{{route('admin.record.daily.absent_search')}}">
                                البحث عن الغياب
                            </a>
                        </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'reports'" x-collapse class="sub-menu text-gray-500">
                        ...
                        <li>
                            <a href="{{route('student.hesas_review_not_done')}}">
                                الحصص الغير منجزة
                            </a>
                        </li>

                        @if(in_array('hesas-review-approve',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('student.hesas_review_waiting_approval')}}">
                                 الحصص المنجزة
                            </a>
                        </li>
                        @endif
                        ...
                        @if(in_array('hesas-review-approve',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.student_has_mission.approved.index')}}">
                                 الحصص المعتمدة 
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('admin.last_student_mission_task.choose_level')}}">
                                آخر مهام الطالب
                            </a>
                        </li>
                ...
                <!--  إدارة منهج الحفظ والمراجعة -->
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'memorize' }" @click="activeDropdown === 'memorize' ? activeDropdown = null : activeDropdown = 'memorize'">
                        <div class="flex items-center">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'memorize' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'memorize'" x-collapse class="sub-menu text-gray-500">
                        ...
                        <li>
                            <a href="{{route('admin.duaacate.dashboard')}}" style="font-family: hafs;">
                ...
                <!-- contact -->
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'contact' }" @click="activeDropdown === 'contact' ? activeDropdown = null : activeDropdown = 'contact'">
                        <div class="flex items-center">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'contact'" x-collapse class="sub-menu text-gray-500">
                        ...
                        @if(in_array('suggestioncate-view',$permissions) || auth()->id() == 1)
                        <li class="nav-item">
                            <a href="{{route('suggestioncate.index')}}" class="group">
                                المقترحات والأفكار
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{route('message.index')}}" class="group">
                        ...
                        <li class="nav-item">
                            <a href="{{route('message.receiver.index')}}" class="group">
                                صلاحيات الإشعارات والتنبيهات
                            </a>
                        </li>
                        @endif
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'semester' }" @click="activeDropdown === 'semester' ? activeDropdown = null : activeDropdown = 'semester'">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'semester' }">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'semester'" x-collapse class="sub-menu text-gray-500">


                        @if(in_array('admin.semester.index',$permissions) || auth()->id() == 1)
                        <li>
                        ...
                        @if(in_array('admin.student.daily_evaluations.truncate',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.student.daily_evaluations.index')}}">
                                بيانات لوحة التقييم اليومي
                            </a>
                        </li>
                        @endif

                        @if(in_array('admin.record.daily.index',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.record.daily.index')}}">
                                قائمة كل السجلات اليومية
                            </a>
                        </li>
                        @endif

                        @if(in_array('admin.warn.dashboard',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.warn.dashboard')}}">
                                التحذير من التأخر والغياب
                            </a>
                        </li>
                        @endif

                        @if(in_array('admin.warning.student_index',$permissions) || auth()->id() == 1)
                        <li>
                            <a href="{{route('admin.warning.student_index')}}">
                                سجل الفصل من الدار
                            </a>
                        </li>
                        @endif
                ...
                @if(in_array('create_and_edit_workperiod',$permissions) || auth()->id() == 1)
                <li class="nav-item">
                    <a href="{{route('workperiod.index')}}" class="group">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @if(in_array('view-level',$permissions) || auth()->id() == 1)
                <li class="nav-item">
                    <a href="{{route('level.index')}}" class="group">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a href="{{route('storednote.create')}}" class="group">
                        <div class="flex items-center">
                            ...
                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                                عبارات الشكر والإطراء
                            </span>
                        </div>
                    </a>
                </li>

                @if(in_array('admin.frontpage.store',$permissions) || auth()->id() == 1)
                <li class="nav-item">
                    <a href="{{ route('admin.frontpage.show') }}" class="group">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0 group-hover:!text-primary">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.73167 5.77133L5.66953 9.91436C4.3848 11.6526 3.74244 12.5217 4.09639 13.205C4.10225 13.2164 4.10829 13.2276 4.1145 13.2387C4.48945 13.9117 5.59888 13.9117 7.81775 13.9117C9.05079 13.9117 9.6673 13.9117 10.054 14.2754L10.074 14.2946L13.946 9.72466L13.926 9.70541C13.5474 9.33386 13.5474 8.74151 13.5474 7.55682V7.24712C13.5474 3.96249 13.5474 2.32018 12.6241 2.03721C11.7007 1.75425 10.711 3.09327 8.73167 5.77133Z" fill="currentColor"></path>
                                <path opacity="0.5" d="M10.4527 16.4432L10.4527 16.7528C10.4527 20.0374 10.4527 21.6798 11.376 21.9627C12.2994 22.2457 13.2891 20.9067 15.2685 18.2286L18.3306 14.0856C19.6154 12.3474 20.2577 11.4783 19.9038 10.7949C19.8979 10.7836 19.8919 10.7724 19.8857 10.7613C19.5107 10.0883 18.4013 10.0883 16.1824 10.0883C14.9494 10.0883 14.3329 10.0883 13.9462 9.72461L10.0742 14.2946C10.4528 14.6661 10.4527 15.2585 10.4527 16.4432Z" fill="currentColor"></path>
                ...
                @if(in_array('update-permission',$permissions) || auth()->id() == 1)
                <li class="nav-item">

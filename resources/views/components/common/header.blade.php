            ...
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span class="text-[8px] ltr:ml-1.5 rtl:mr-1.5  text-center hidden md:inline dark:text-white-light transition-all duration-300">
                        <div> مؤسسة دار الإتقان العالي </div>
                    </span>
                </a>
            ...
            <div x-data="header" class="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                            ...
                            <div class="group flex items-center px-4 py-2" @click.self="toggle">
                                ...
                                <div class="flex flex-auto ltr:pl-3 rtl:pr-3">
                                    <a href="{{ $notification->data['url'] }}">
                                        ...
                                        <div class="text-xs">{{ $notification->created_at->format('d-m-Y H:i') }}</div>
                                    </a>
                                </div>
                            </div>
                        </li>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="ltr:right-0 rtl:left-0 text-dark dark:text-white-dark top-11 !py-0 w-[230px] font-semibold dark:text-white-light/90">
                        ...
                        <li>
                            <a href="{{ route('message.index') }}" class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            ...
                            <div class="flex gap-1 p-2 text-[10px] {{ auth()->user()->workperiod_id == $workperiod->id ? 'bg-brownLight' : '' }}">
                                <a class="{{$workperiod->gender=='m'?'text-blue-600':'text-orange-600'}}" href="{{route('change_workperiod',$workperiod->id)}}">

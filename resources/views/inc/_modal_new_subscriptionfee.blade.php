<div class="mb-5" x-data="modal_create_subscriptionfee">

    <a href="#" class="btn btn-outline-warning" @click="toggle"> + جديد </a>
    ...
    <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="open && '!block'">
        <div class="flex min-h-screen items-center justify-center px-4" @click.self="open = false">
            <div x-show="open" x-transition x-transition.duration.300 class="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0">
                ...
                <form method="post" action="{{ route('admin.subscriptionfee.store') }}" class="p-4">
                    @csrf
                    <div class="p-5">
                    ...
                    <div class="w-full">
                            ...
                            <x-text-input id="amount" name="amount" type="number" class="mt-1 w-full" step="any" value="10.000" />
                        ...
                        <div class="mt-2">
                            ...
                            <textarea name="note" class="mt-1 h-20 rounded w-full border"></textarea>

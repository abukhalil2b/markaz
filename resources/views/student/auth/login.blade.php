<x-layouts.guest>
    ...
    <form method="POST" action="{{ route('student.login') }}">
        ...
        <div>
            رقم الطالب
            <x-text-input class="block mt-1 w-full" type="number" name="id" :value="old('id')" required autofocus />
        ...
        <div class="mt-4">
            ...
            <div class="input-container">
                ...
                <x-input name="password" id="passwordInput" type="password" class="form-control " placeholder="كلمة المرور" />
            </div>

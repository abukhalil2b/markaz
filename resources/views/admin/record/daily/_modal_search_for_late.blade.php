<div class="mb-5" x-data="modal_search_for_late">

    <a href="#" class="btn btn-outline-secondary" @click="toggle">  البحث عن الحضور المتأخر </a>
    ...
    <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="open && '!block'">
        <div class="flex min-h-screen items-center justify-center px-4" @click.self="open = false">
            <div x-show="open" x-transition x-transition.duration.300 class="panel my-8 w-full max-w-lg overflow-hidden rounded-lg border-0 p-0">
                ...
                <form method="post" action="{{ route('admin.record.daily.late_search') }}" class="p-4">
                    @csrf
                    <div class="p-5">
...
<script>
    document.addEventListener("alpine:init", () => {
        ...
        Alpine.data("modal_search_for_late", () => ({

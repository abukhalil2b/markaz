...
return [
	...
	*/
	...
	'attributes' => [
		"receiverIds"=>"المستلمين",
		"studentIds"=>'معرف الطلاب',
		"workperiodId"=>'معرف فترات العمل',
		"datefrom"=>'من',
		"dateto"=>'إلى',
		"body"=>'الموضوع',
		...
		"available" => "مُتاح",
		"size" => "الحجم",
		"onesoracate_id" => "التصنيف",
		"passedReadingStatus"=>"الإجازة في القراءة",
		"answer_content" => 'الإجابة'
	],
